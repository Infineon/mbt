...
```
        copy cyw5551x to target board through usb disk or wifi or ethernet
        cd cyw5551x
        cd scripts_for_xavier
                sudo ./bt_load.sh autobaud or
                sudo ./bt_load.sh aufo3m or
                sudo ./bt_load.sh soft3m or
...
For Nvidia jeston Xaiver,
  export MBT_TRANSPORT=/dev/ttyTHS1
